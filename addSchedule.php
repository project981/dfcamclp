...
<div class="container-fluid">
    <div class="row" id="location_modal">
        <div class="col-6 border-left" id="frm-field">
            <h3>Entrance Exam Schedule Form: (<?php echo $_GET['d'] ?>)</h3>
            <hr>
            ...
            <input type="hidden" name="date_sched" value="<?php echo $_GET['d'] ?>">
                ...
                <div class="form-group">
                    ...
                    <select type="text" class="custom-select" name="citizen" required>
               ...
               <div class="form-group">
                    ...
                    <select type="text" class="custom-select" name="civil" required>
                ...
                <div class="form-group">
                    <label for="course" class="control-label">Course Applied</label>
                ...
                <div class="form-group">
                    <label for="dob" class="control-label">Previous School</label>
                    <input type="text" class="form-control" name="prev" required>
                </div>
                <div class="form-group">
            ...
            <hr>
                <div class="form-group">
                    <label for="guardian" class="control-label">Guardians Name</label>
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">Contact</label>
                    <input type="text" class="form-control" name="contact1" required>
                </div>
                
            <hr>
                
                <div class="form-group d-flex justify-content-end">
                    <button type="submit" name="submit" class="btn-dark btn">Submit Schedule</button>&nbsp;<button type="button" class="btn-danger btn">Cancel</button>
                </div>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
                        ...
                        var ins = "<small><i>Copy or take a snapshot of the code below your name. The code will serve as your identification number for exam schedule. Please bring atleast 1 ID to verify your schedule information.</i></small>";
